...
const OnProgress = () => {
    ...
    useEffect(() => {
        async function fetchData(){
            let result = await fetch("http://localhost:8001/v1/course/on-progress?item_per_page=8&page=1", {
                method: 'GET',
            ...
            <div className='bg-container w-100'>
                <div className='container py-5'>
                    <div className='row'>
                        ...
                        }): "Kamu belum mendaftar course apapun"}
                    </div>
                </div>
            </div>
            <Pagination
                ...
                pageSize={4}
                onPageChange={page => {
                    var url = "/on-progress?page=" + page.toString();
                    navigate(url);
